 ...
 */
package io.awspring.spring.data.dynamodb.service;
...
import io.awspring.spring.data.dynamodb.model.AccountNote;
import io.awspring.spring.data.dynamodb.model.AccountProfile;
import io.awspring.spring.data.dynamodb.model.Address;
import io.awspring.spring.data.dynamodb.model.AggregateOrder;
import io.awspring.spring.data.dynamodb.model.Customer;
import io.awspring.spring.data.dynamodb.model.CustomerAccount;
import io.awspring.spring.data.dynamodb.model.Order;
import io.awspring.spring.data.dynamodb.model.OrderByIndex;
import io.awspring.spring.data.dynamodb.model.OrderItem;
import io.awspring.spring.data.dynamodb.model.OrderStatus;
import io.awspring.spring.data.dynamodb.model.PaymentMethod;
import io.awspring.spring.data.dynamodb.repository.AggregateOrderRepository;
import io.awspring.spring.data.dynamodb.repository.CustomerAccountRepository;
import io.awspring.spring.data.dynamodb.repository.CustomerRepository;
import io.awspring.spring.data.dynamodb.repository.OrderByIndexRepository;
import io.awspring.spring.data.dynamodb.repository.OrderItemRepository;
import io.awspring.spring.data.dynamodb.repository.OrderRepository;
