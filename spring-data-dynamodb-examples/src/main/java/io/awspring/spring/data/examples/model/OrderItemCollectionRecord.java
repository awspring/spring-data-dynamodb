...
public record OrderItemCollectionRecord(@ItemCollectionMember(regex = "^#PROFILE$") Customer customer,
		@ItemCollectionMember(regex = "^ORDER#[^#]+$") Order order,
		@ItemCollectionMember(regex = "^ORDER#[^#]+#ITEM#.+$") List<OrderItem> orderItemList) {
}
