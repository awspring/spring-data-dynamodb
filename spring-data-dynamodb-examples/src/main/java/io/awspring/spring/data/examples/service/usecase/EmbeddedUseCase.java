...
@Component
@Order(90)
public class EmbeddedUseCase implements ExampleUseCase {

	private final CustomerRepository customers;
	private final CustomerAccountRepository accounts;

	public EmbeddedUseCase(CustomerRepository customers, CustomerAccountRepository accounts) {
	...
	@Override
	public String title() {
		return "@Embedded nested values and routed row containers";
	}
