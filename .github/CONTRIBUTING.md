...
Spring Data DynamoDB is released under the non-restrictive Apache 2.0 license,
...
* We use the [Spotless](https://github.com/diffplug/spotless) project
  to apply code formatting conventions. Format the code running
  `./mvnw spotless:apply`
