...
public abstract class AbstractDynamoDbConfiguration implements BeanClassLoaderAware, BeanFactoryAware {
	...
	/**
	 * Creates the default AWS SDK client for standalone configurations. Override this method and annotate it with
	 * {@link Bean @Bean} to register a client without external auto-configuration.
	 * @return the default AWS SDK DynamoDB client
	 */
