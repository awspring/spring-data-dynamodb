...
class MappingDynamoDbConverterTest {
	...
	@Nested
	@DisplayName("Embedded chaining")
	class EmbeddedChaining {

		@Test
		@DisplayName("null flattened @Embedded update clears every nested column")
		void nullFlattenedEmbeddedUpdateClearsEveryNestedColumn() {
		...
		@Test
		@DisplayName("Chained @Embedded flattens all levels and reconstructs on read")
		void chainedEmbeddedProperties_flattenAllLevels_reconstruct() {
	...
	public static class RegexRoutedRow {
		...
		@SortKey
		private String sk;
		@Embedded(regex = "ORDER#[^#]+")
		private OrderPart order;
		@Embedded(regex = "ORDER#[^#]+#LINE#[^#]+")
		private OrderLinePart line;
		@Embedded(regex = "ORDER#[^#]+#LINE#[^#]+#ITEM#[^#]+")
